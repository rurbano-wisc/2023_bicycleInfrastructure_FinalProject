...
4. 
5. Bike lanes and infrastructure – separated multi-use paths, painted lanes, etc.; need to determine which of the following; BL a. https://www.cyclosm.org/#map=11/33.9277/-118.2843/cyclosm b. https://www.opencyclemap.org/

Interaction Section—widgets 
Filter Widget—this will filter the layer of choice 
